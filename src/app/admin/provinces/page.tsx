...
"use client";
// This page is no longer directly used for province management.
// Province management is now part of /admin/locations.
...
export default function OldAdminProvincesPage() {
  const router = useRouter();

  useEffect(() => {
    router.replace('/admin/locations?tab=provinces');
  }, [router]);
  ...
  return (
    <main className="min-h-screen bg-background p-4 md:p-8 flex flex-col justify-center items-center">
      <div className="text-center">
        ...
        <p className="text-sm">
          Province management has been moved. If you are not redirected, please
          <Link href="/admin/locations?tab=provinces" className="text-primary hover:underline ml-1">
            click here
          </Link>.
        </p>
